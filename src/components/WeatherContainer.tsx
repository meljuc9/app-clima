...
export const WeatherContainer = ({
  ...
  useEffect(() => {
    if (fetchedData)
      setWeather({
        ...
        feels: Math.floor(fetchedData.main.feels_like - 273) + "Cº",
  ...
  return (
    <main className="w-96 rounded--3x1 bg-gradient-to-b from-gray-800 to-gray-700 shadow-lg">
        {error === "" ? (
            <div className="flex w-full items-center flex-col p-8 text-white">
